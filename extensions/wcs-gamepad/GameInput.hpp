...
namespace wcs_gamepad
{
    ...
    public:
        ...
        virtual void SystemAction(CompanionSystemAction action, InputState state, uint32_t time) = 0;
    ...
    public:
        ...
        void SystemAction(CompanionSystemAction action, InputState state, uint32_t time) override;
