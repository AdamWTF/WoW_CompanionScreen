...
const WXL_PluginInfo* __cdecl WXL_Query(void)
{
    static const WXL_PluginInfo info = {
        sizeof(WXL_PluginInfo), WXL_API_VERSION, "wcs-gamepad", 0x010001, WXL_CLIENT_BUILD,
    };
    return &info;
}
...
int __cdecl WXL_Load(const WXL_Api* api)
{
    ...
    wcs_gamepad::Log(WXL_LOG_INFO, "initialising WoW Companion Screen gamepad 1.0.1 for WoW 3.3.5a build 12340");
