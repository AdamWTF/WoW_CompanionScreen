...
WCS.ActionOverlay = { layer = "default" }
local Overlay = WCS.ActionOverlay
...
function Overlay:Create()
    ...
    local frame = CreateFrame("Frame", "WCSActionOverlay", UIParent); frame:SetSize(frameWidth, frameHeight); frame:SetPoint("BOTTOM", UIParent, "BOTTOM", 0, 42); frame:SetFrameStrata("MEDIUM")
    self.frame, self.cells = frame, {}
    self.l2Indicator = frame:CreateTexture(nil, "OVERLAY"); self.l2Indicator:SetSize(28, 28); self.l2Indicator:SetPoint("BOTTOMRIGHT", frame, "TOP", -2, 2); self.l2Indicator:SetTexture(WCS.Glyphs:GetModifier("l2"))
    self.r2Indicator = frame:CreateTexture(nil, "OVERLAY"); self.r2Indicator:SetSize(28, 28); self.r2Indicator:SetPoint("BOTTOMLEFT", frame, "TOP", 2, 2); self.r2Indicator:SetTexture(WCS.Glyphs:GetModifier("r2"))
...
function Overlay:Refresh()
    ...
    self.frame:SetScale(WCSDB.display.actionScale or 1)
