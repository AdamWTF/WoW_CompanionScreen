import { ShortcutBinding, ThorPadPreferences } from "@/bridge/protocol";
...
export function defaultPreferences(): ThorPadPreferences {
  return {
    hostIp: null,
    deviceId: makeId(),
    deviceName: "AYN Thor",
...
export function loadPreferences(): ThorPadPreferences {
...
export function savePreferences(preferences: ThorPadPreferences) {
