...
//
//   Detour      The existing kInit detour (m2compat, 0x83CF00) routes here when the resident load buffer
//               starts with the raw 'MD21' chunk tag. A stock MD20 v264 model takes the untouched
//               original parser -- the modern path costs stock models one magic compare.
...
namespace wxl::runtime::m2native
{
    ...
    bool Enabled() { return wxl::features::modernM2Support; }
...
WXL_REGISTER_FEATURE("m2native", wxl::features::modernM2Support, InstallM2Native)
