...
namespace
{
     ...
     *
     * When the native MD21 reader is compiled in (config.hpp modernM2Support) and the resident buffer is
...
WXL_REGISTER_FEATURE("m2compat-loader", wxl::features::modernM2Support, InstallM2CompatLoader)
