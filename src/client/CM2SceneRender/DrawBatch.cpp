...
namespace wxl::features::render::detail
{
    ...
    DrawInterceptFn g_drawIntercept = nullptr;
    ...
    {
        if (DrawInterceptFn intercept = g_drawIntercept)
        {
            g_drawIntercept = nullptr;
        ...
        // already tracked above, so "is this an M2 batch" costs nothing extra.
