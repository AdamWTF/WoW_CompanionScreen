...
namespace
{
    ...
    {
        if (!wxl::hook::Install("M2InitializeLoaded", off::kInitializeLoaded, &hkInitializeLoaded,
...
WXL_REGISTER_FEATURE("particle-blend-mode", wxl::features::modernM2Support, InstallEmitterBlend)
