 ...
 *
 * Everything here is always compiled in and the hot path is three increments on plain
 * render-thread-local counters; the atomics are touched once per frame, not once per draw.
 */
